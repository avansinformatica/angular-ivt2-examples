...
//
const appname = 'angular-fileupload';

// Point static path to dist
app.use(express.static(path.join(__dirname, 'client', 'dist', appname)));

// Catch all routes and return the index file
app.get('*', (req, res) => {
    res.sendFile(path.join(__dirname, 'client', 'dist', appname, 'index.html'));
});
